...
(function(root, factory) {
    ...
    function handleTweets(tweets) {
        if (customCallbackFunction === null) {
            ...
            var html = '<div class="row"><div class="grid">';
            while (n < x) {
                html += '<div class="span6 element-item"  data-category="transition">' + tweets[n] + '</div>';
                n++;
            }
            html += '</div></div>';
            ...
            if (dataOnly) {
                ...
                while (n < x) {
                    ...
                    if (parseLinks) {
                        ...
                        op += '<div class="tweet"><a href="' + permalinksURL[n] + '">' + strip(tweets[n].innerHTML) + '</a><div class="user"><h4>' + strip(authors[n].innerHTML) + '</h4></div></div>';
                    }
